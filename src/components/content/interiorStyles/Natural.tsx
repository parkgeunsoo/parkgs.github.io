        ...
        <Container>
            <div className='interior-image'>
                <div className='interior-image__left'
                        ...
                        style={{}}
                    >
                    <img src={`${process.env.PUBLIC_URL}/images/interior-natural-01.jpg`} alt="Monochrome Photograph Livingroom" />
                ...
                <div className='interior-image__right'
                    ...
                    style={{}}
                >
                    <img src={`${process.env.PUBLIC_URL}/images/interior-natural-02.jpg`} alt="" />
            ...
            <div className='interior-image center'>
                <div className='interior-image__center'
                   ...
                   style={{}}
                >
                    <img src={`${process.env.PUBLIC_URL}/images/interior-natural-03.jpg`} alt="" />
                    <p className='side-txt'><span>Monochrome Photograph</span>Livingroom</p>
