        ...
        <Container>
            <div className='interior-image'>
                <div className='interior-image__left'
                        ...
                        style={{}}
                    >
                    <img src={`${process.env.PUBLIC_URL}/images/interior-classic-01.jpg`} alt="Monochrome Photograph Livingroom" />
                ...
                <div className='interior-image__right'
                    ...
                    style={{}}
                >
                    <img src={`${process.env.PUBLIC_URL}/images/interior-classic-02.jpg`} alt="" />
                    <p className='side-txt'><span>Monochrome Photograph</span>Enterance</p>
                </div>
            </div>
            <div className="asd">
                <div className="text" ref={textRef}>classic</div>
            </div>
            <div className='interior-image center'>
                <div className='interior-image__center'
                   ...
                   style={{}}
                >
                    <img src={`${process.env.PUBLIC_URL}/images/interior-classic-03.jpg`} alt="" />
                    <p className='side-txt'><span>Monochrome Photograph</span>Livingroom</p>
