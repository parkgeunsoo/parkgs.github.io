...
const MainContentsSlider = [
    { 
        id: 1, 
        mainImgSrc: `${process.env.PUBLIC_URL}/images/index-2-bath-kv-01.jpg`, 
        mainImgAlt: "키친" , 
        title:"Lifestyle", 
    ...
    { 
        id: 2, 
        mainImgSrc: `${process.env.PUBLIC_URL}/images/index-2-bath-kv-02.jpg`, 
        mainImgAlt: "키친", title:"Timeless", 
        text: "시간이 지나도 변하지 않을 가치를 담기 위해 노력합니다." 
    },
    { 
        id: 3, 
        mainImgSrc: `${process.env.PUBLIC_URL}/images/index-2-bath-kv-03.jpg`, 
        mainImgAlt: "키친", 
        title:"Originality",  
    ...
    { 
        id: 4, 
        mainImgSrc: `${process.env.PUBLIC_URL}/images/index-2-bath-kv-04.jpg`, 
        mainImgAlt: "키친", 
...
const ContentsImg = [
    {
      imgSrc: `${process.env.PUBLIC_URL}/images/product-bath-img01.jpg`,
      alt: '화장실',
      title: '고품격 욕실을 위한 최고의 파트너 브랜드',
      desc: '취미가 일상 속에서 더 빛을 발하는 순간. 잘 짜여진 수납 시스템과 고품질의 가전제품, 그리고 관리하기 쉬운 조리대 상판은 요리하는 내내 즐거움을 선사합니다.',
    },
    {
      imgSrc: `${process.env.PUBLIC_URL}/images/product-bath-img02.jpg`,
      alt: '화장실',
    ...
    {
      imgSrc: `${process.env.PUBLIC_URL}/images/index-6-wallmaterials-img-04.jpg`,
      alt: 'Tile',
      title: '스마트한 키친 시스템',
...
const ContentsSlider = [
    { 
        id: 1, 
        slideImgSrc: `${process.env.PUBLIC_URL}/images/detail-bath-01.jpg`, 
        slideImgAlt: "화장실" , 
        title:"Soif Marble", 
    ...
    { 
        id: 2, 
        slideImgSrc: `${process.env.PUBLIC_URL}/images/detail-bath-02.jpg`, 
        slideImgAlt: "화장실", 
        title:"Siena", 
    ...
    { 
        id: 3, 
        slideImgSrc: `${process.env.PUBLIC_URL}/images/detail-bath-03.jpg`, 
        slideImgAlt: "화장실", 
    ...
    { 
        id: 4, 
        slideImgSrc: `${process.env.PUBLIC_URL}/images/detail-bath-04.jpg`, 
        slideImgAlt: "화장실", 
        title:"Forest Green", 
...
const GradeLink = [
    { 
        gradeImg: `${process.env.PUBLIC_URL}/images/product-bath-premium.jpg`, 
        gradeSrc: "프리미엄 관련 이미지" , 
        title:"Premium", 
        text: "프리미엄 바스"
    },
    { 
        gradeImg: `${process.env.PUBLIC_URL}/images/product-bath-standard.jpg`, 
  ...
  return (
    <div className='sub-wrap'>
        <div className='main-visual'>
            <img src={`${process.env.PUBLIC_URL}/images/bath-main-visual.jpg`} alt="" />
